...
public class TC8 {
	...
	public void login() {
		...
		String cartproductPriceLocator = String.format("//h3[text()='%s']/parent::div/following-sibling::div[@class='prodTotal cartSection']/p", productSelection);
		...
		String orderPriceLocator= String.format("//div[text()='ZARA COAT 3']/parent::td/following-sibling::td/div[@class='title']", productSelection);
		String orderPrice= driver.findElement(By.xpath("//div[text()='ZARA COAT 3']/parent::td/following-sibling::td/div[@class='title']")).getText();
		Assert.assertEquals(orderPrice, price);
		
		((JavascriptExecutor)driver).executeScript(
			    "document.querySelector(\"div[aria-label='Order Placed Successfully']\")?.remove();");
