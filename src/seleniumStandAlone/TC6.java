...
public class TC6 {
	...
	public void login() {
		...
		// Wait until page loading overlay disappears
		...
		String myOrderLocator = String.format("//td[text()='%s']", productSelection);
		Assert.assertTrue(driver.findElement(By.xpath(myOrderLocator)).isDisplayed(), "Order is Not displayed");
		driver.close();
	}
}
